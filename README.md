...
Могу сказать, что по итогу ни один из этих трёх путей не был верным, даже последний, который я и использовал был плох, всё же осталось много разговора, модели было сложно выучить саму "математику" и упёрлась в потолок своих возможностей.
...
В итоговом результате в качестве учителя выступала модель **Qwen/Qwen3-8B-AWQ**
